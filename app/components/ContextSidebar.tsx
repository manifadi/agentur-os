...
import { Briefcase, Plus, Users, Settings, Pencil, Search } from 'lucide-react';
        ...
        <aside className="w-64 bg-gray-50/50 border-r border-gray-200 flex flex-col h-full overflow-y-auto flex-shrink-0 animate-in slide-in-from-left-4 duration-300">
            <div className="p-4 flex-1 flex flex-col min-h-min">
                ...
                <div className="relative mb-3">
                    <input type="text" placeholder="Suchen..." className="w-full bg-white border border-gray-200 rounded-lg text-xs py-2 pl-8 pr-2 focus:ring-1 focus:ring-gray-300 outline-none" />
