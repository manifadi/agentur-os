        ...
        <div className="space-y-4">
            <div className="flex items-center justify-between px-2">
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="font-black text-text-primary text-sm tracking-tight uppercase">Aktive Projekte</h3>
                </div>
                <span className="bg-accent text-accent-text text-[10px] px-3 py-1 rounded-full font-black uppercase tracking-widest shadow-sm">
                    {projects.length}
                </span>
            </div>
            <ProjectList
